...
class Map(db.Model):
    ...
    GamemodeID = db.Column(db.Integer, db.ForeignKey('Gamemode.ID', ondelete='CASCADE', onupdate='CASCADE'), nullable=False)
    ...
    victors = db.relationship("Victor", back_populates="map", cascade="all, delete-orphan")
    sections = db.relationship("Section", back_populates="map", cascade="all, delete-orphan")
